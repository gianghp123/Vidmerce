...
func (m *MockAssetRepository) CreateWithImages(ctx context.Context, asset models.AssetEntity, images []models.ImageEntity) error {
	args := m.Called(ctx, asset, images)
	return args.Error(0)
}

func (m *MockAssetRepository) CreateWithJob(ctx context.Context, asset models.AssetEntity, job models.JobEntity) error {
	args := m.Called(ctx, asset, job)
	return args.Error(0)
}
